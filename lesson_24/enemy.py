...
for frame in range(1, 4):
    image = pygame.image.load(f'enemy/Custom Edited - Mario Customs - Pokey Sunshine Design SMW-Style-Photoroom{frame}.png').convert_alpha()
...
def movement_enemy(player_rect, enemy_rect, enemy_speed_x, enemy_speed_y):
    ...
    # Движение противника
    enemy_rect.x += delta_x * enemy_speed_x
    enemy_rect.y += delta_y * enemy_speed_y
